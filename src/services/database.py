...
def popular_banco_mock():
    ...
    perfis_faltantes = [
        perfil for perfil in perfis_mock if perfil[0] not in ids_existentes
    ]

    if not perfis_faltantes:
        return

    print("Populando banco com perfis de teste...")

    for id_usuario, nome, perfil in perfis_faltantes:
        salvar_perfil_usuario(id_usuario, nome, perfil)
