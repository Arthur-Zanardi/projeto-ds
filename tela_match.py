...
def main(page: ft.Page):
    ...
    header = ft.Container(
        content=ft.Row(
            controls=[
                ft.IconButton(icon=ft.Icons.ARROW_BACK, icon_color=ft.Colors.BLACK87),
                ft.Text("Seu Match", size=18, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK87),
    ...
    traits_row = ft.Row(
        controls=[
            ft.Container(
                content=ft.Text(trait, size=12, color=ft.Colors.BLACK87),
    ...
    main_card = ft.Container(
        content=ft.Column([
            ...
            ft.Container(
                content=ft.Column([
                    ft.Text(f"{match['nome']}, {match['idade']}", size=24, weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK87),
                    ft.Text(f"{match['localização']} • {match['cargo']}", color=ft.Colors.GREY_700),
                    ft.Divider(color=ft.Colors.TRANSPARENT, height=10),
                    ft.Text("Personality", weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK87),
                    traits_row,
                ]),
                padding=20
            )
